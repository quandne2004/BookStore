...
namespace BookStore.Repositories
{
    public class CartRepository: ICartRepository
    {
        ...
        public async Task<ShoppingCart> GetUserCart()
        {
            ...
            var shoppingCart = await _db.ShoppingCarts.Include(a => a.CartDetails).ThenInclude(a => a.Book).ThenInclude(a => a.Gerne).Where(a => a.UserId == userId).FirstOrDefaultAsync();
            return shoppingCart;
        }
